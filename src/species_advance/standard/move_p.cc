...
// In this file, we are not using SIMD vectors over vectors of particles or
// field voxels.  So, without further study, the vectors in this file are
// not candidates for V8_ACCELERATION.
// // High performance variant based on SPE accelerated version
...
//   /*const*/ v8float one( 1.f );
//   /*const*/ v8float tiny( 1e-37f );
//   /*const*/ v8int   sign_bits( 1<<31 );

//   v8float dr, r, u, q, q3;
//   v8float sgn_dr, s, sdr;
//   v8float v0, v1, v2, v3, v4, v5, _stack_vf;
//   v8int bits, _stack_vi;
