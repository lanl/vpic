...
inline void load_4x1_tr( const void* a0, const void* a1, const void* a2,
                         const void* a3, v4& a )
{
    a.v = ( _v4_float ){( (const float*)a0 )[0], ( (const float*)a1 )[0],
...
BINARY(
    ...
    t.v = a.v; u.v = b.v; c.v = ( _v4_float )( ( _v4_int ){
                              t.i[0] / u.i[0], t.i[1] / u.i[1], t.i[2] / u.i[2],
                              t.i[3] / u.i[3]} ) ) // FIXME: Sigh ...
BINARY(
    %,
    union {
...
LOGICAL( >=, c.v = (_v4_float)vec_xor( _true, vec_cmplt( (_v4_int)a.v,
                                                         (_v4_int)b.v ) ) )
LOGICAL( &&, c.v = (_v4_float)
                 vec_xor( _true, vec_or( vec_cmpeq( (_v4_int)a.v, _false ),
                                         vec_cmpeq( (_v4_int)b.v, _false ) ) ) )
LOGICAL( ||, c.v = (_v4_float)vec_xor(
                 _true, vec_and( vec_cmpeq( (_v4_int)a.v, _false ),
                                 vec_cmpeq( (_v4_int)b.v, _false ) ) ) )
