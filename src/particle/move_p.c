...
int move_p( particle_t       * ALIGNED p,
...
int remove_p( particle_t * ALIGNED r,
...
int inject_p( particle_t * ALIGNED p0,       /* Array to inject into */
              int n,                                  /* Where to inject */
              particle_mover_t * ALIGNED pm, /* Particle mover */
              field_t * ALIGNED f,
