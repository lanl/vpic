...
class v4
{
    ...
    friend inline void transpose( v4& a0, v4& a1, v4& a2,
                                  v4& a3 ) ALWAYS_INLINE;
    ...
    friend inline v4 merge( const v4int& c, const v4& a,
    ...
    friend inline void load_4x4_tr( const void* ALIGNED( 16 ) a0,
                                    ...
                                    const void* ALIGNED( 16 ) a2,
                                    const void* ALIGNED( 16 ) a3, v4& a, v4& b,
                                    v4& c, v4& d ) ALWAYS_INLINE;

    friend inline void load_4x8_tr( const void* ALIGNED( 16 ) a0,
                                    const void* ALIGNED( 16 ) a1,
                                    const void* ALIGNED( 16 ) a2,
                                    const void* ALIGNED( 16 ) a3, v4& b00,
                                    v4& b01, v4& b02, v4& b03, v4& b04, v4& b05,
                                    v4& b06, v4& b07 ) ALWAYS_INLINE;

    friend inline void
    load_4x16_tr( const void* ALIGNED( 16 ) a0, const void* ALIGNED( 16 ) a1,
                  const void* ALIGNED( 16 ) a2, const void* ALIGNED( 16 ) a3,
                  v4& b00, v4& b01, v4& b02, v4& b03, v4& b04, v4& b05, v4& b06,
                  v4& b07, v4& b08, v4& b09, v4& b10, v4& b11, v4& b12, v4& b13,
    ...
    friend inline void
    store_4x8_tr( const v4& b00, const v4& b01, const v4& b02, const v4& b03,
                  const v4& b04, const v4& b05, const v4& b06, const v4& b07,
...
inline int any( const v4& a ) { return a.i[0] || a.i[1] || a.i[2] || a.i[3]; }

inline int all( const v4& a ) { return a.i[0] && a.i[1] && a.i[2] && a.i[3]; }
...
inline void load_4x1_tr( const void* a0, const void* a1, const void* a2,
                         const void* a3, v4& a )
{
...
inline void load_4x3_tr( const void* ALIGNED( 16 ) a0,
                         const void* ALIGNED( 16 ) a1,
                         const void* ALIGNED( 16 ) a2,
                         const void* ALIGNED( 16 ) a3, v4& a, v4& b, v4& c )
{
...
inline void load_4x8_tr( const void* ALIGNED( 16 ) a0,
                         const void* ALIGNED( 16 ) a1,
                         const void* ALIGNED( 16 ) a2,
                         const void* ALIGNED( 16 ) a3, v4& b00, v4& b01,
                         v4& b02, v4& b03, v4& b04, v4& b05, v4& b06, v4& b07 )
{
...
inline void load_4x16_tr( const void* ALIGNED( 16 ) a0,
                          ...
                          const void* ALIGNED( 16 ) a3, v4& b00, v4& b01,
                          v4& b02, v4& b03, v4& b04, v4& b05, v4& b06, v4& b07,
                          v4& b08, v4& b09, v4& b10, v4& b11, v4& b12, v4& b13,
                          v4& b14, v4& b15 )
{
...
inline void store_4x2_tr( const v4& a, const v4& b, void* ALIGNED( 8 ) a0,
...
#if 1
inline void store_4x8_tr( const v4& b00, const v4& b01, const v4& b02,
                          const v4& b03, const v4& b04, const v4& b05,
                          const v4& b06, const v4& b07, void* ALIGNED( 16 ) a0,
...
class v4int : public v4
{
    ...
    friend inline v4 merge( const v4int& c, const v4& t,
...
#define CMATH_FR1( fn )                                                        \
    friend inline v4float fn( const v4float& a ) ALWAYS_INLINE
#define CMATH_FR2( fn )                                                        \
...
inline v4int operator&&( const v4float& a, const v4float& b )
{
    ...
    c.vsi = vandq_s32( vmvnq_u32( vceqq_f32( a.v, vzero ) ),
                       vmvnq_u32( vceqq_f32( b.v, vzero ) ) );
...
inline v4int operator||( const v4float& a, const v4float& b )
{
    ...
    // Is there a better way to do this than the SSE way?
    c.vsi = vorrq_s32( vmvnq_u32( vceqq_f32( a.v, vzero ) ),
                       vmvnq_u32( vceqq_f32( b.v, vzero ) ) );
...
#undef CMATH_FR2
                    ...
                    inline v4float
    copysign( const v4float& a, const v4float& b )
{
    v4float c;
    float t;
...
inline v4float rsqrt( const v4float& a )
{
    ...
    b.v = vaddq_f32(
        ...
        vmulq_f32(
            ...
            vsubq_f32(
                b_v,
                vmulq_f32( a_v, vmulq_f32( b_v, vmulq_f32( b_v, b_v ) ) ) ) ) );
...
inline v4float rcp( const v4float& a )
{
    ...
    b.v = vsubq_f32( vaddq_f32( b_v, b_v ),
                     vmulq_f32( a_v, vmulq_f32( b_v, b_v ) ) );
