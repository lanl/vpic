...
%
D. Kerbyson\thanks{Computer, Computational, and Statistical Sciences Division (CCS-1 Computer Science on High Performance Computing), Los Alamos National Laboratory, Los Alamos, NM 87544, Email: \emph{djk@lanl.gov}}
}
\date{\today}
...
\textbf{P2} Measured Results on ASDS}
...
200kb in size; the number of particles migrating to each neighbor may 
...
PPU to Cell PPU (across tri-blades) was measured to be 10.5 $\mu$s on 
...
Performance Advantage & 11.7x & 11.7x & 11.7x & 11.7x \\
\hline
\end{tabular}
\end{center}
