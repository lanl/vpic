...
void advance_e_pipeline_scalar( pipeline_args_t* args, int pipeline_rank,
                                int n_pipeline );

void advance_e_pipeline_v4( pipeline_args_t* args, int pipeline_rank,
                            int n_pipeline );

void advance_e_pipeline_v8( pipeline_args_t* args, int pipeline_rank,
                            int n_pipeline );

void advance_e_pipeline_v16( pipeline_args_t* args, int pipeline_rank,
                             int n_pipeline );
