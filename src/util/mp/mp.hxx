...
error_code mp_begin_recv_cxx( int rbuf, int size, int sender,
	int tag, mp_handle h );

error_code mp_begin_send_cxx( int sbuf, int size, int receiver,
	int tag, mp_handle h );

error_code mp_end_recv_cxx( int rbuf, mp_handle h );

error_code mp_end_send_cxx( int sbuf, mp_handle h );

error_code mp_allsum_d_cxx( double *local, double *global, int n,
	mp_handle h );

error_code mp_allsum_i_cxx( int *local, int *global, int n,
	mp_handle h );

error_code mp_allgather_i_cxx( int *sbuf, int *rbuf, int n,
	mp_handle h );
...
error_code mp_recv_i_cxx( int *buf, int n, int src, mp_handle h );
