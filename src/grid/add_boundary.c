...
/* Define custom boundary handler for grid g.  Return integer tag in
   ...
   set_pbc in the same context as absorb_particles, reflect_particles, etc.
   to associate boundary handler with boundary.  Space for handlers is 
   automatically allocated.  
*/

int IUO_add_boundary( grid_t *g, boundary_handler_t handler, const void * initial_params, int sz ) {
