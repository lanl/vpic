...
private:
  ...
  // Note: user_global is aliased with user_global_t (see deck_wrapper.cpp)
  ...
  // Field helpers are provided by macros in deck_wrapper.cpp
  ...
  ////////////////////////////////////////////////////////////
  // User input deck provided functions (see deck_wrapper.cpp)
