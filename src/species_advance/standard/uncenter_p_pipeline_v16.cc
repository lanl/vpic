                         ...
                         int n_pipeline )
{
  ...
  for( ; nq; nq--, p+=16 )
  {
    ...
    vp08 = ( const float * ALIGNED(16) ) ( f0 + ii( 8) );
    vp09 = ( const float * ALIGNED(16) ) ( f0 + ii( 9) );
    vp10 = ( const float * ALIGNED(16) ) ( f0 + ii(10) );
    vp11 = ( const float * ALIGNED(16) ) ( f0 + ii(11) );
    vp12 = ( const float * ALIGNED(16) ) ( f0 + ii(12) );
    vp13 = ( const float * ALIGNED(16) ) ( f0 + ii(13) );
    vp14 = ( const float * ALIGNED(16) ) ( f0 + ii(14) );
    vp15 = ( const float * ALIGNED(16) ) ( f0 + ii(15) );
