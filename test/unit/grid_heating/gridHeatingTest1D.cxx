...
//define_material( "impermeable_vacuum_xr", 1 );
  ...
  if ( load_particles!=0 ) {
    ...
    seed_entropy( 922129 );  // Kevin said it should be this way
...
# define should_dump(x) \
  ...
  if( should_dump(energies) ) {
            dump_energies( "rundata_1d/energies", step() ==0 ? 0 : 1 );
  } //if
...
TEST_CASE( "grid heating test in 1d", "[grid_heating]" )
{
    // Init and run sim
