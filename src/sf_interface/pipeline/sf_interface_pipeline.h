...
void clear_array_pipeline_scalar( reduce_pipeline_args_t* args,
                                  int pipeline_rank, int n_pipeline );

///////////////////////////////////////////////////////////////////////////////
// reduce_array_pipeline interface

void reduce_array_pipeline_scalar( reduce_pipeline_args_t* args,
                                   int pipeline_rank, int n_pipeline );

void reduce_array_pipeline_v4( reduce_pipeline_args_t* args, int pipeline_rank,
                               int n_pipeline );

void reduce_array_pipeline_v8( reduce_pipeline_args_t* args, int pipeline_rank,
                               int n_pipeline );

void reduce_array_pipeline_v16( reduce_pipeline_args_t* args, int pipeline_rank,
                                int n_pipeline );
