...
void accumulate_hydro_p_pipeline_scalar(
    accumulate_hydro_p_pipeline_args_t* args, int pipeline_rank,
    int n_pipeline );

void accumulate_hydro_p_pipeline_v4( accumulate_hydro_p_pipeline_args_t* args,
                                     int pipeline_rank, int n_pipeline );

void accumulate_hydro_p_pipeline_v8( accumulate_hydro_p_pipeline_args_t* args,
                                     int pipeline_rank, int n_pipeline );

void accumulate_hydro_p_pipeline_v16( accumulate_hydro_p_pipeline_args_t* args,
                                      int pipeline_rank, int n_pipeline );
