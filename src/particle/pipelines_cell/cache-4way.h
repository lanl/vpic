...
unsigned int __cache_replace_cntr[CACHE_NSETS] __attribute__ ((aligned (16)));
...
#   ifdef CACHE_BASE_EA
    unsigned long long ea64 =
      (unsigned long long)(CACHE_BASE_EA) +
      (unsigned long long)ea_aligned;
    spu_mfcdma64 (CACHE_ADDR(lnum, 0), mfc_ea2h(ea64), mfc_ea2l(ea64),
	    CACHELINE_SIZE, tagid, MFC_PUT_CMD);
#   else
    spu_mfcdma32 (CACHE_ADDR(lnum, 0), ea_aligned,
	    CACHELINE_SIZE, tagid, MFC_PUT_CMD);
#   endif
...
#   ifdef CACHE_BASE_EA
    unsigned long long ea64 =
      ...
      (unsigned long long)ea_aligned;
    spu_mfcdma64 (CACHE_ADDR (lnum, 0), mfc_ea2h(ea64), mfc_ea2l(ea64),
	    CACHELINE_SIZE, __cache_tagid (set), MFC_GETF_CMD);
#   else
    spu_mfcdma32 (CACHE_ADDR (lnum, 0), ea_aligned,
	    CACHELINE_SIZE, __cache_tagid (set), MFC_GETF_CMD);
#   endif
