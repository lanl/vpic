...
void begin_remote_ghost_tang_b( field_t * RESTRICT ALIGNED field,
				const grid_t * RESTRICT g ) {
...
void end_remote_ghost_tang_b( field_t * RESTRICT ALIGNED field,
			      const grid_t * RESTRICT g ) {
  const int nx = g->nx, ny = g->ny, nz = g->nz;
  int face, x, y, z;
  float *p, lw, rw;
...
void begin_remote_ghost_norm_e( field_t * RESTRICT ALIGNED field,
                                const grid_t * RESTRICT g ) {
  const int nx = g->nx, ny = g->ny, nz = g->nz;
  int size, face, x, y, z;
  float *p;
...
void end_remote_ghost_norm_e( field_t * RESTRICT ALIGNED field,
                              const grid_t * RESTRICT g ) {
  const int nx = g->nx, ny = g->ny, nz = g->nz;
  int face, x, y, z;
  float *p, lw, rw;
...
void begin_remote_ghost_div_b( field_t * RESTRICT ALIGNED field,
                               const grid_t * RESTRICT g ) {
  const int nx = g->nx, ny = g->ny, nz = g->nz;
  int size, face, x, y, z;
  float *p;
...
void end_remote_ghost_div_b( field_t * RESTRICT ALIGNED field,
                             const grid_t * RESTRICT g ) {
  const int nx = g->nx, ny = g->ny, nz = g->nz;
  int face, x, y, z;
  float *p, lw, rw;
...
double synchronize_tang_e_norm_b( field_t * RESTRICT ALIGNED field,
				  const grid_t * RESTRICT g ) {
...
void synchronize_jf( field_t * RESTRICT ALIGNED field,
                     const grid_t * RESTRICT g ) {
  int size, face, x, y, z, nx, ny, nz;
  float *p, lw, rw;
  field_t *f;
...
void synchronize_rhof( field_t * RESTRICT ALIGNED field,
                       const grid_t * RESTRICT g ) {
  int size, face, x, y, z, nx, ny, nz;
  float *p, lw, rw;
  field_t *f;
...
void synchronize_rhob( field_t * RESTRICT ALIGNED field,
                       const grid_t * RESTRICT g ) {
  int size, face, x, y, z, nx, ny, nz;
  float *p, lw, rw;
  field_t *f;
...
void synchronize_hydro( hydro_t * RESTRICT ALIGNED hydro,
                        const grid_t * RESTRICT g ) {
  int size, face, x, y, z, nx, ny, nz;
  float *p, lw, rw;
  hydro_t *h;
