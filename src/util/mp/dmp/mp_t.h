...
// A mp can handle up to 54 simultaneous communications (27 sends and
// 27 receives) ... This is based on every volume, face, edge and
// corner of a box simultaneously engaged in an overlapped send and an
// overlapped receive
