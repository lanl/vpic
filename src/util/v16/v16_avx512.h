                       ...
                       v16 &a15 )
{
    ...
    t06 =
        _mm512_unpacklo_ps( a06.v, a07.v ); //  96 112  97 113 100 116 101 117
                                            //  104 120 105 121 108 124 109 125
    t07 =
        _mm512_unpackhi_ps( a06.v, a07.v ); //  98 114  99 115 102 118 103 119
    ...
    a00.v = _mm512_shuffle_ps( t00, t02,
                               _MM_SHUFFLE( 1, 0, 1, 0 ) ); //   0  16  32  48
    a01.v = _mm512_shuffle_ps( t00, t02,
                               _MM_SHUFFLE( 3, 2, 3, 2 ) ); //   1  17  33  49
    a02.v = _mm512_shuffle_ps( t01, t03,
                               _MM_SHUFFLE( 1, 0, 1, 0 ) ); //   2  18  34  50
    a03.v = _mm512_shuffle_ps( t01, t03,
                               _MM_SHUFFLE( 3, 2, 3, 2 ) ); //   3  19  35  51
              ...
              v16 &b00, v16 &b01 )
{
    ...
    u04 = _mm512_shuffle_ps(
        ...
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); //  64  80  96 112  68  84 100 116  72  88
                                     //  104 120  76  92 108 124
    u05 = _mm512_shuffle_ps(
        t04, t06,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); //  65  81  97 113  69  85 101 117  73  89
                                     //  105 121  77  93 109 125
    u08 = _mm512_shuffle_ps(
        t08, t10,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 128 144 160 176 132 148 164 180 136 152
                                     // 168 184 140 156 172 188
    u09 = _mm512_shuffle_ps(
        t08, t10,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 129 145 161 177 133 149 165 181 137 153
                                     // 169 185 141 157 173 189
    u12 = _mm512_shuffle_ps(
        t12, t14,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 192 208 224 240 196 212 228 244 200 216
                                     // 232 248 204 220 236 252
    u13 = _mm512_shuffle_ps(
        t12, t14,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 193 209 225 241 197 213 229 245 201 217
                                     // 233 249 205 221 237 253

    t00 = _mm512_shuffle_f32x4( u00, u04,
                                0x88 ); //   0  16  32  48   8  24  40  56  64
                                        //   80  96 112  72  88 104 120
    t01 = _mm512_shuffle_f32x4( u01, u05,
                                0x88 ); //   1  17  33  49   9  25  41  57  65
                                        //   81  97 113  73  89 105 121
              ...
              v16 &b00, v16 &b01, v16 &b02 )
{
    ...
    u06 = _mm512_shuffle_ps(
        t05, t07,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); //  66  82  98 114  70  86 102 118  74  90
                                     //  106 122  78  94 110 126
    u08 = _mm512_shuffle_ps(
        t08, t10,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 128 144 160 176 132 148 164 180 136 152
                                     // 168 184 140 156 172 188
    ...
    u10 = _mm512_shuffle_ps(
        t09, t11,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 130 146 162 178 134 150 166 182 138 154
                                     // 170 186 142 158 174 190
    u12 = _mm512_shuffle_ps(
        t12, t14,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 192 208 224 240 196 212 228 244 200 216
                                     // 232 248 204 220 236 252
    ...
    u14 = _mm512_shuffle_ps(
        t13, t15,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 194 210 226 242 198 214 230 246 202 218
                                     // 234 250 206 222 238 254
    ...
    t02 = _mm512_shuffle_f32x4( u02, u06,
                                0x88 ); //   2  18  34  50  10  26  42  58  66
                                        //   82  98 114  74  90 106 122
    t08 = _mm512_shuffle_f32x4( u08, u12,
                                0x88 ); // 128 144 160 176 136 152 168 184 192
                                        // 208 224 240 200 216 232 248
    t09 = _mm512_shuffle_f32x4( u09, u13,
              ...
              v16 &b00, v16 &b01, v16 &b02, v16 &b03 )
{
    ...
    u07 = _mm512_shuffle_ps(
        t05, t07,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); //  67  83  99 115  71  87 103 119  75  91
                                     //  107 123  79  95 111 127
    u08 = _mm512_shuffle_ps(
        t08, t10,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 128 144 160 176 132 148 164 180 136 152
                                     // 168 184 140 156 172 188
    ...
    u11 = _mm512_shuffle_ps(
        t09, t11,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 131 147 163 179 135 151 167 183 139 155
                                     // 171 187 143 159 175 191
    u12 = _mm512_shuffle_ps(
        t12, t14,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 192 208 224 240 196 212 228 244 200 216
                                     // 232 248 204 220 236 252
    ...
    u15 = _mm512_shuffle_ps(
        t13, t15,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 195 211 227 243 199 215 231 247 203 219
                                     // 235 251 207 223 239 255
    ...
    t03 = _mm512_shuffle_f32x4( u03, u07,
                                0x88 ); //   3  19  35  51  11  27  43  59  67
                                        //   83  99 115  75  91 107 123
    t08 = _mm512_shuffle_f32x4( u08, u12,
                                0x88 ); // 128 144 160 176 136 152 168 184 192
                                        // 208 224 240 200 216 232 248
    t09 = _mm512_shuffle_f32x4( u09, u13,
              ...
              v16 &b06, v16 &b07 )
{
    ...
    t04 = _mm512_shuffle_f32x4( u00, u04,
                                0xdd ); //   4  20  36  52  12  28  44  60  68
                                        //   84 100 116  76  92 108 124
    t05 = _mm512_shuffle_f32x4( u01, u05,
                                0xdd ); //   5  21  37  53  13  29  45  61  69
                                        //   85 101 117  77  93 109 125
    t06 = _mm512_shuffle_f32x4( u02, u06,
                                0xdd ); //   6  22  38  54  14  30  46  62  70
                                        //   86 102 118  78  94 110 126
    t07 = _mm512_shuffle_f32x4( u03, u07,
                                0xdd ); //   7  23  39  55  15  31  47  63  71
                                        //   87 103 119  79  95 111 127
    t08 = _mm512_shuffle_f32x4( u08, u12,
                                0x88 ); // 128 144 160 176 136 152 168 184 192
                                        // 208 224 240 200 216 232 248
    t09 = _mm512_shuffle_f32x4( u09, u13,
               ...
               v16 &b12, v16 &b13, v16 &b14, v16 &b15 )
{
    ...
    t05 = _mm512_unpackhi_ps( b04.v, b05.v ); //  66  82  67  83  70  86  71  87
                                              //  74  90  75  91  78  94  79  95
    t06 =
        _mm512_unpacklo_ps( b06.v, b07.v ); //  96 112  97 113 100 116 101 117
                                            //  104 120 105 121 108 124 109 125
    t07 =
        _mm512_unpackhi_ps( b06.v, b07.v ); //  98 114  99 115 102 118 103 119
                                            //  106 122 107 123 110 126 111 127
                ...
                v16 &b06, v16 &b07 )
{
    ...
    __m512i idx = _mm512_set_epi32( 15, 11, 14, 10, 13, 9, 12, 8, 7, 3, 6, 2, 5,
                                    1, 4, 0 );
    ...
    b00.v =
        _mm512_permutexvar_ps( idx, t00 ); //   0   8  16  24  32  40  48  56 64
                                           //   72  80  88  96 104 112 120
    b01.v =
        _mm512_permutexvar_ps( idx, t01 ); //   1   9  17  25  33  41  49  57 65
                                           //   73  81  89  97 105 113 121
    b02.v =
        _mm512_permutexvar_ps( idx, t02 ); //   2  10  18  26  34  42  50  58 66
                                           //   74  82  90  98 106 114 122
    b03.v =
        _mm512_permutexvar_ps( idx, t03 ); //   3  11  19  27  35  43  51  59 67
                                           //   75  83  91  99 107 115 123
    b04.v =
        _mm512_permutexvar_ps( idx, t04 ); //   4  12  20  28  36  44  52  60 68
                                           //   76  84  92 100 108 116 124
    b05.v =
        _mm512_permutexvar_ps( idx, t05 ); //   5  13  21  29  37  45  53  61 69
                                           //   77  85  93 101 109 117 125
    b06.v =
        _mm512_permutexvar_ps( idx, t06 ); //   6  14  22  30  38  46  54  62 70
                                           //   78  86  94 102 110 118 126
    b07.v =
        _mm512_permutexvar_ps( idx, t07 ); //   7  15  23  31  39  47  55  63 71
                 ...
                 v16 &b12, v16 &b13, v16 &b14, v16 &b15 )
{
    ...
    b07.v =
        _mm512_permutexvar_ps( idx, t07 ); //   7  15  23  31  39  47  55  63 71
                                           //   79  87  95 103 111 119 127
    b08.v =
        _mm512_permutexvar_ps( idx, t08 ); // 128 136 144 152 160 168 176 184
                                           // 192 200 208 216 224 232 240 248
    b09.v =
        _mm512_permutexvar_ps( idx, t09 ); // 129 137 145 153 161 169 177 185
                                           // 193 201 209 217 225 233 241 249
    b10.v =
        _mm512_permutexvar_ps( idx, t10 ); // 130 138 146 154 162 170 178 186
                                           // 194 202 210 218 226 234 242 250
    b11.v =
        _mm512_permutexvar_ps( idx, t11 ); // 131 139 147 155 163 171 179 187
                                           // 195 203 211 219 227 235 243 251
    b12.v =
        _mm512_permutexvar_ps( idx, t12 ); // 132 140 148 156 164 172 180 188
                                           // 196 204 212 220 228 236 244 252
    b13.v =
        _mm512_permutexvar_ps( idx, t13 ); // 133 141 149 157 165 173 181 189
                                           // 197 205 213 221 229 237 245 253
    b14.v =
        _mm512_permutexvar_ps( idx, t14 ); // 134 142 150 158 166 174 182 190
                                           // 198 206 214 222 230 238 246 254
    b15.v =
        _mm512_permutexvar_ps( idx, t15 ); // 135 143 151 159 167 175 183 191
    ...
    void *ALIGNED( 64 ) a15 )
{
    ...
    u00 = _mm512_shuffle_ps( t00, t02,
                             _MM_SHUFFLE( 1, 0, 1, 0 ) ); //   0  16  32  48
    u01 = _mm512_shuffle_ps( t00, t02,
                             _MM_SHUFFLE( 3, 2, 3, 2 ) ); //   1  17  33  49
    u02 = _mm512_shuffle_ps( t01, t03,
                             _MM_SHUFFLE( 1, 0, 1, 0 ) ); //   2  18  34  50
    u03 = _mm512_shuffle_ps( t01, t03,
                             _MM_SHUFFLE( 3, 2, 3, 2 ) ); //   3  19  35  51
                             ...
                             void *ALIGNED( 64 ) a06, void *ALIGNED( 64 ) a07 )
{
    ...
    __m512i idx = _mm512_set_epi32( 15, 13, 11, 9, 14, 12, 10, 8, 7, 5, 3, 1, 6,
                                    4, 2, 0 );
    ...
    t06 = _mm512_shuffle_ps(
        u04, u05,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); //  96 112  97 113 100 116 101 117 104 120
                                     //  105 121 108 124 109 125
    t07 = _mm512_shuffle_ps(
        u06, u07,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); //  98 114  99 115 102 118 103 119 106 122
                                     //  107 123 110 126 111 127
    ...
    u06 = _mm512_shuffle_ps(
        t06, t07,
        _MM_SHUFFLE( 2, 0, 2, 0 ) ); //  96  97  98  99 100 101 102 103 104 105
    ...
    void *ALIGNED( 64 ) a15 )
{
    ...
    t07 =
        _mm512_permutexvar_ps( idx, b07.v ); //   7  23  39  55  15  31  47  63
                                             //   71  87 103 119  79  95 111 127
    t08 =
        _mm512_permutexvar_ps( idx, b08.v ); // 128 144 160 176 136 152 168 184
                                             // 192 208 228 240 200 216 232 248
    t09 =
        _mm512_permutexvar_ps( idx, b09.v ); // 129 145 161 177 137 153 169 185
                                             // 193 209 229 241 201 217 233 249
    t10 =
        _mm512_permutexvar_ps( idx, b10.v ); // 130 146 162 178 138 154 170 186
                                             // 194 210 230 242 202 218 234 250
    t11 =
        _mm512_permutexvar_ps( idx, b11.v ); // 131 147 163 179 139 155 171 187
                                             // 195 211 231 243 203 219 235 251
    t12 =
        _mm512_permutexvar_ps( idx, b12.v ); // 132 148 164 180 140 156 172 188
                                             // 196 212 228 244 204 220 236 252
    t13 =
        _mm512_permutexvar_ps( idx, b13.v ); // 133 149 165 181 141 157 173 189
                                             // 197 213 229 245 205 221 237 253
    t14 =
        _mm512_permutexvar_ps( idx, b14.v ); // 134 150 166 182 142 158 174 190
                                             // 198 214 230 246 206 222 238 254
    t15 =
        _mm512_permutexvar_ps( idx, b15.v ); // 135 151 167 183 143 159 175 191
    ...
    t08 = _mm512_shuffle_ps(
        u08, u09,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 128 144 129 145 132 148 133 149 136 152
                                     // 137 153 140 156 141 157
    t09 = _mm512_shuffle_ps(
        u10, u11,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 130 146 131 147 134 150 135 151 138 154
                                     // 139 155 142 158 143 159
    t10 = _mm512_shuffle_ps(
        u08, u09,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 160 176 161 177 164 180 165 181 168 184
                                     // 169 185 172 188 173 189
    t11 = _mm512_shuffle_ps(
        u10, u11,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 162 178 163 179 166 182 167 183 170 186
                                     // 171 187 174 190 175 191
    t12 = _mm512_shuffle_ps(
        u12, u13,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 192 208 193 209 196 212 197 213 200 216
                                     // 201 217 204 220 205 221
    t13 = _mm512_shuffle_ps(
        u14, u15,
        _MM_SHUFFLE( 1, 0, 1, 0 ) ); // 194 210 195 211 198 214 199 215 202 218
                                     // 203 219 206 222 207 223
    t14 = _mm512_shuffle_ps(
        u12, u13,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 224 240 225 241 228 244 229 245 232 248
                                     // 233 249 236 252 237 253
    t15 = _mm512_shuffle_ps(
        u14, u15,
        _MM_SHUFFLE( 3, 2, 3, 2 ) ); // 226 242 227 243 230 246 231 247 234 250
                                     // 235 251 238 254 239 255
    ...
    u08 = _mm512_shuffle_ps(
        t08, t09,
        _MM_SHUFFLE( 2, 0, 2, 0 ) ); // 128 129 130 131 132 133 134 135 136 137
                                     // 138 139 140 141 142 143
    u09 = _mm512_shuffle_ps(
        t08, t09,
        _MM_SHUFFLE( 3, 1, 3, 1 ) ); // 144 145 146 147 148 149 150 151 152 153
                                     // 154 155 156 157 158 159
    u10 = _mm512_shuffle_ps(
        t10, t11,
        _MM_SHUFFLE( 2, 0, 2, 0 ) ); // 160 161 162 163 164 165 166 167 168 169
                                     // 170 171 172 173 174 175
    u11 = _mm512_shuffle_ps(
        t10, t11,
        _MM_SHUFFLE( 3, 1, 3, 1 ) ); // 176 177 178 179 180 181 182 183 184 185
                                     // 186 187 188 189 190 191
    u12 = _mm512_shuffle_ps(
        t12, t13,
        _MM_SHUFFLE( 2, 0, 2, 0 ) ); // 192 193 194 195 196 197 198 199 200 201
                                     // 202 203 204 205 206 207
    u13 = _mm512_shuffle_ps(
        t12, t13,
        _MM_SHUFFLE( 3, 1, 3, 1 ) ); // 208 209 210 211 212 213 214 215 216 217
                                     // 218 219 220 221 222 223
    u14 = _mm512_shuffle_ps(
        t14, t15,
        _MM_SHUFFLE( 2, 0, 2, 0 ) ); // 224 225 226 227 228 229 230 231 232 233
