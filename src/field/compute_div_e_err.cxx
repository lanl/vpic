...
#define COMPUTE_DIV_E_ERR_PIPELINE (pipeline_func_t)compute_div_e_err_pipeline
#else
#define COMPUTE_DIV_E_ERR_PIPELINE (pipeline_func_t)compute_div_e_err_pipeline_v4
#endif
