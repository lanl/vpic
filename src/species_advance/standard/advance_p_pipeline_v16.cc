...
// modified load_16x16_tr_a and store_16x16_tr_a functions which load or
		        ...
		        int n_pipeline )
{
  ...
  for( ; nq; nq--, p+=32 )
  {
    load_16x16_tr_a( &p[ 0].dx, &p[ 2].dx, &p[ 4].dx, &p[ 6].dx,
    ...
    //--------------------------------------------------------------------------
    store_16x16_tr_a( v03_a, v04_a, v05_a, ii_a, v06_a, v07_a, v08_a, q_a,
