...
// It does not appear that the SIMD parallelism here is over vectors of particles
// or fields and thus does not seem a candidate for V8_ACCELERATION without more
// study.
//   using namespace v8;
